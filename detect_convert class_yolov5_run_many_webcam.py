...
class yolov5():
    def __init__(self,source,
        ...
        self.source = source
    def run(self,ten,project = 'runs/detect', name = 'exp'):
        visualize = ""
        ...
        # Directories
        save_dir = increment_path(Path(project) / name, exist_ok=self.exist_ok)  # increment run
        ...
        for path, im, im0s, vid_cap, s in dataset:
            ...
            # Inference
            with dt[1]:
                self.visualize = increment_path(save_dir / Path(path).stem, mkdir=True) if visualize else False
...
if __name__ == '__main__':
    ...
    thread1 = yolov5(source="full.mp4")
    # thread2 = yolov5(source="test.mp4")
    # thread3 = yolov5(source="video (7).mp4")
    # thread4 = yolov5(source="video (8).mp4")
    t1 = threading.Thread(target=thread1.run,args=("1",)).start()
    # t2 = threading.Thread(target=thread2.run,args=("2",)).start()
    # t3 = threading.Thread(target=thread3.run, args=("3",)).start()
    # t4 = threading.Thread(target=thread4.run, args=("4",)).start()
